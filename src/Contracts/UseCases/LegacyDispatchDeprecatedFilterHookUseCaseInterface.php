...
/**
 * Use case interface for applying a deprecated filter hook.
 *
 * ## Specification
 *
 * - As a user, given a deprecated hook name, arguments, and version, I want the filter applied and a deprecation notice
 *   triggered.
 ...
 * - As a user, when no callbacks are registered to the deprecated hook, I want the first argument returned unchanged.
 * - As a user, I want the deprecation notice to include the version when the hook was deprecated.
 * - As a user, I want the hook to behave like a normal filter (applying callbacks in priority order) while also
...
{
    /**
     * Fires a deprecated filter hook and applies callbacks.
     *
     * @param string $hook_name
     *   The name of the deprecated filter hook.
     * @param array $args
     *   Array of arguments passed to the filter callbacks.
